-- Migration 016: Add Jazz Music Style
-- Created: 2025-12-04
-- Purpose: Add Jazz as a musical stylistic period and seed with Internet Archive jazz track

-- =============================================================================
-- ADD JAZZ TO STYLISTIC_PERIOD ENUM
-- =============================================================================

-- Note: PostgreSQL doesn't support ALTER TYPE ... ADD VALUE in transactions by default
-- We need to add the new value outside of a transaction block
-- This is safe to run multiple times (will error if value exists, but won't corrupt data)
