...
(
    ...
    50,
    'MODERN',
    ARRAY['meditative', 'piano', 'slow', 'minimal', 'atmospheric'],
    'https://archive.org/download/ErikSatieGymnopdieNo.1/Erik%20Satie%20-%20Gymnop%C3%A9die%20No.1.mp3',
    '{"type": "Public Domain", "attribution": "Internet Archive", "url": "https://archive.org/details/ErikSatieGymnopdieNo.1", "verified": true}'::jsonb,
    0.97,
    true
),
(
    ...
    65,
    'MODERN',
    ARRAY['american', 'orchestral', 'pastoral', 'uplifting'],
    'https://archive.org/download/ACoplandAppalachianSpring/Appalachian%20Spring.mp3',
    '{"type": "Public Domain", "attribution": "Internet Archive", "url": "https://archive.org/details/ACoplandAppalachianSpring", "verified": true}'::jsonb,
    0.93,
    true
),

-- =============================================================================
-- CELTIC TRADITIONAL - NEW
-- =============================================================================
(
    'INTERNET_ARCHIVE',
    'Andersons (Slow)',
    'Traditional Irish',
    'Stephen Ducke - Irish Flute',
    180,
    55,
    'CELTIC_TRADITIONAL',
    ARRAY['traditional', 'flute', 'celtic', 'peaceful', 'melodic'],
    'https://archive.org/download/TradschoolIrishFluteTunes/andersons_slow.mp3',
    '{"type": "CC-BY-SA 3.0", "attribution": "Stephen Ducke / Tradschool", "url": "https://archive.org/details/TradschoolIrishFluteTunes", "verified": true}'::jsonb,
    0.88,
    true
),
(
    'INTERNET_ARCHIVE',
    'The Humours of Lissadell (Slow)',
    'Traditional Irish',
    'Stephen Ducke - Irish Flute',
    165,
    60,
    'CELTIC_TRADITIONAL',
    ARRAY['traditional', 'flute', 'celtic', 'gentle', 'flowing'],
    'https://archive.org/download/TradschoolIrishFluteTunes/humours_of_lissadell_slow.mp3',
    '{"type": "CC-BY-SA 3.0", "attribution": "Stephen Ducke / Tradschool", "url": "https://archive.org/details/TradschoolIrishFluteTunes", "verified": true}'::jsonb,
    0.86,
    true
),
...
-- =============================================================================
-- CONTEMPORARY PERIOD (1975-present) - NEW
-- =============================================================================
(
    'INTERNET_ARCHIVE',
    'Womb of Tranquility',
    ...
    48,
    'CONTEMPORARY',
    ARRAY['ambient', 'meditation', 'tranquil', 'modern', 'peaceful'],
    'https://archive.org/download/freefloatingmusic-aic2013/06%20-%20Silvercord%20-%20Womb%20of%20Tranquility.mp3',
    '{"type": "CC-BY-NC-ND 4.0", "attribution": "Silvercord / Free Floating Music", "url": "https://archive.org/details/freefloatingmusic-aic2013", "verified": true}'::jsonb,
    0.90,
    true
);
...
-- Modern Meditation (Early 20th century minimalism)
WITH inserted_playlist AS (
    INSERT INTO music_playlists (
        name, description, intended_intensity, intended_use,
        stylistic_period, duration_minutes_target, is_active, is_featured
    ) VALUES (
        'Modern Meditation - 20 min',
        'Early 20th century minimalist and pastoral pieces. Features Satie''s meditative piano and Copland''s American pastoral.',
        'LOW',
        'MEDITATION',
        'MODERN',
        20,
...
SELECT
    ...
    ROW_NUMBER() OVER (ORDER BY t.bpm) - 1
FROM music_tracks t
WHERE t.stylistic_period = 'MODERN'
ORDER BY t.bpm;

-- Contemporary Ambient (21st century calm)
WITH inserted_playlist AS (
    INSERT INTO music_playlists (
        name, description, intended_intensity, intended_use,
        stylistic_period, duration_minutes_target, is_active, is_featured
    ) VALUES (
        'Contemporary Ambient - 15 min',
        'Modern ambient meditation music perfect for deep relaxation and mindful movement.',
        'LOW',
        'MEDITATION',
        'CONTEMPORARY',
        15,
...
SELECT
    ...
    ROW_NUMBER() OVER (ORDER BY t.title) - 1
FROM music_tracks t
WHERE t.stylistic_period = 'CONTEMPORARY'
ORDER BY t.title;

-- Celtic Cool-Down (Traditional Irish calm)
WITH inserted_playlist AS (
    INSERT INTO music_playlists (
        name, description, intended_intensity, intended_use,
        stylistic_period, duration_minutes_target, is_active, is_featured
    ) VALUES (
        'Celtic Cool-Down - 15 min',
        'Gentle Irish flute melodies for peaceful cool-down and stretching. Traditional tunes played slowly and melodically.',
        'LOW',
        'PILATES_STRETCH',
        'CELTIC_TRADITIONAL',
        15,
